...
namespace FNAScreenSaver.Core
{
    ...
    public class GameEngine : Game
    {
        ...
        private SnowflakeCreator snowflakeManager = null!;
        ...
        protected override void LoadContent()
        {
            ...
            background = Content.Load<Texture2D>("snowyVillage");
            var snowflakeTexture = Content.Load<Texture2D>("snowflake");

            var width = GraphicsDevice.Viewport.Width;
            var height = GraphicsDevice.Viewport.Height;

            snowflakeManager = new SnowflakeCreator(snowflakeTexture, Constants.Count, width, height);
        }
